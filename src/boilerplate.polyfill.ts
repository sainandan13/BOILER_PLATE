...
SelectQueryBuilder.prototype.paginate = async function<T> (
    ...
    // Verify skip is a valid number before passing to TypeORM
    if (isNaN(skip)) {
      throw new Error('Invalid pagination parameters: calculated skip is not a number');
    }
